...
bot.on('photo', async (msg) => {
  ...
  if (!getban.status) return bot.sendMessage(chatId, `You have been banned\n\nReason : ${getban.reason}\n\nDo you want to be able to use 𝐔𝐋𝐓𝐈𝐌𝐀𝐓𝐔𝐌 again? Please contact the owner to request removal of the ban\nOwner : @isaacarinola`)
...
[English]
Please send a link to the video or post you want to download, the bot only supports social media on the list. Don't give us problem. 
